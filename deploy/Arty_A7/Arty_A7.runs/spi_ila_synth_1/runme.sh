...
HD_PWD='/home/binhkieudo/Workspace/XRPIX/urisc-serv/serial_riscv/deploy/Arty_A7/Arty_A7.runs/spi_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_ila.tcl
