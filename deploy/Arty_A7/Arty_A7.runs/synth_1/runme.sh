...
HD_PWD='/home/binhkieudo/Workspace/XRPIX/urisc-serv/serial_riscv/deploy/Arty_A7/Arty_A7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_artya7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_artya7.tcl
