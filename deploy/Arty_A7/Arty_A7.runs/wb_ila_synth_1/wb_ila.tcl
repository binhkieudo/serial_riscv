...
synth_design -top wb_ila -part xc7a35ticsg324-1L -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix wb_ila_ wb_ila.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ wb_ila_stub.v
 lappend ipCachedFiles wb_ila_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ wb_ila_stub.vhdl
 lappend ipCachedFiles wb_ila_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ wb_ila_sim_netlist.v
 lappend ipCachedFiles wb_ila_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ wb_ila_sim_netlist.vhdl
 lappend ipCachedFiles wb_ila_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp wb_ila.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips wb_ila]
 }
...
rename_ref -prefix_all wb_ila_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef wb_ila.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "wb_ila_synth_1_synth_report_utilization_0" "report_utilization -file wb_ila_utilization_synth.rpt -pb wb_ila_utilization_synth.pb"
