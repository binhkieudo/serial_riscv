...
HD_PWD='/home/binhkieudo/Workspace/XRPIX/urisc-serv/serial_riscv/deploy/Arty_A7/Arty_A7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_artya7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_artya7.tcl -notrace
