...
#set_property -dict {PACKAGE_PIN U29 IOSTANDARD LVCMOS18} [get_ports o_prog_cmplt];  # LA32_N
#set_property -dict {PACKAGE_PIN U31 IOSTANDARD LVCMOS18} [get_ports o_prog_flash];  # LA33_P
#set_property -dict {PACKAGE_PIN T31 IOSTANDARD LVCMOS18} [get_ports boot_led    ];  # LA33_N
...
set_property -dict {PACKAGE_PIN R30 IOSTANDARD LVCMOS18} [get_ports jtag_trst];  # LA24_P
set_property -dict {PACKAGE_PIN P31 IOSTANDARD LVCMOS18} [get_ports jtag_tdi ];  # LA24_N
set_property -dict {PACKAGE_PIN K29 IOSTANDARD LVCMOS18} [get_ports jtag_tms ]; # LA25_P
set_property -dict {PACKAGE_PIN K30 IOSTANDARD LVCMOS18} [get_ports jtag_tck ]; # LA25_N
set_property -dict {PACKAGE_PIN J30 IOSTANDARD LVCMOS18} [get_ports jtag_tdo ]; # LA26_P
...
set_property -dict {PACKAGE_PIN V35 IOSTANDARD LVCMOS18} [get_ports SCK];  # LA28_P
set_property -dict {PACKAGE_PIN V36 IOSTANDARD LVCMOS18} [get_ports CSn];  # LA28_N
set_property -dict {PACKAGE_PIN W36 IOSTANDARD LVCMOS18} [get_ports MOSI];  # LA29_P
set_property -dict {PACKAGE_PIN W37 IOSTANDARD LVCMOS18} [get_ports MISO];  # LA29_N
#set_property -dict {PACKAGE_PIN T32 IOSTANDARD LVCMOS18} [get_ports {FMC2_J16[4]}];  # LA30_P
set_property -dict {PACKAGE_PIN R32 IOSTANDARD LVCMOS18} [get_ports FLASH_RST];  # LA30_N
set_property -dict {PACKAGE_PIN V39 IOSTANDARD LVCMOS18} [get_ports FLASH_WP];  # LA31_P
set_property -dict {PACKAGE_PIN V40 IOSTANDARD LVCMOS18} [get_ports FLASH_HOLD];  # LA31_N
...
## LEDs
set_property -dict {PACKAGE_PIN AM39 IOSTANDARD LVCMOS18} [get_ports o_prog_cmplt];
set_property -dict {PACKAGE_PIN AN39 IOSTANDARD LVCMOS18} [get_ports o_prog_flash];
set_property -dict {PACKAGE_PIN AR37 IOSTANDARD LVCMOS18} [get_ports boot_led];
set_property -dict {PACKAGE_PIN AT37 IOSTANDARD LVCMOS18} [get_ports q];
...
## DIP Switches
set_property -dict {PACKAGE_PIN AV30 IOSTANDARD LVCMOS18} [get_ports boot_mode];
set_property -dict {PACKAGE_PIN AY33 IOSTANDARD LVCMOS18} [get_ports prog_mode];
...
## Pushbuttons
set_property -dict {PACKAGE_PIN AR40 IOSTANDARD LVCMOS18} [get_ports i_rst]; # GPIO_PB[3]
#set_property -dict {PACKAGE_PIN AU38 IOSTANDARD LVCMOS18} [get_ports GPIO_PB[4]];
#set_property -dict {PACKAGE_PIN AP40 IOSTANDARD LVCMOS18} [get_ports GPIO_PB[5]];
#set_property -dict {PACKAGE_PIN AW40 IOSTANDARD LVCMOS18} [get_ports GPIO_PB[6]];
#set_property -dict {PACKAGE_PIN AV39 IOSTANDARD LVCMOS18} [get_ports GPIO_PB[7]];