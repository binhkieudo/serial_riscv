...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_13 -L processing_system7_vip_v1_0_15 -L xil_defaultlib -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot zynq_top xil_defaultlib.zynq_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  zynq_top -key {Behavioral:sim_1:Functional:zynq_top} -tclbatch cmd.tcl -protoinst "protoinst_files/zynq_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb zynq_top.wdb xsim.dir)
