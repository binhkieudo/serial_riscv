...
#
# Generated by Vivado on Sun Aug 27 11:54:35 JST 2023
...
# Script info
echo -e "ila_0.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../pynq.gen/sources_1/ip/ila_0/hdl/verilog" +incdir+"/opt/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../pynq.gen/sources_1/ip/ila_0/hdl/verilog" +incdir+"/opt/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../pynq.gen/sources_1/ip/ila_0/hdl/verilog" +incdir+"/opt/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../pynq.gen/sources_1/ip/ila_0/sim/ila_0.v" \
  2>&1 | tee -a vlogan.log
